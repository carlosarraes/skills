...
> Invoke the Skill tool: skill=`prep-ticket`, args=`PROJ-1234`. Follow the skill fully. Return its report verbatim as your final message.

If the harness's agents cannot invoke skills, point the agent at the file instead: "Read `<skills-dir>/prep-ticket/SKILL.md` and execute it for PROJ-1234."
