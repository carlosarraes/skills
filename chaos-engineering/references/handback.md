...
Show **every selected experiment** and every planned-but-unselected, unreachable, or category-skipped experiment. Preserve resilient, fixed, failed, inconclusive, and skipped outcomes; include expected versus observed evidence, all three failed attempts where applicable, each fix's file/line/commit, and scope-boundary follow-ups. The overall verdict is exactly **yes / partial / no** and cannot be `yes` while a material failure or inconclusive selected case remains.
