...
In explicit simulation/preview mode, state the exact target and render the would-be plan/diff/confirmation trace, but **do not write**, mkdir, replace, or otherwise mutate a file.
